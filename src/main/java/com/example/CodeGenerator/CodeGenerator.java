...
import com.example.CodeGenerator.template.Template;
...
public class CodeGenerator {
    ...
    /** 模板位置 */
    private static final String TEMPLATE_FILE_PATH = PROJECT_PATH + JAVA_PATH + packageConvertPath(Template.packAge);
    /** 资源文件路径 */
    ...
    public static void main(String[] args) {
         ...
         */
        String[][] arrNames = {{"sm_map", "", "用户表", "Integer"}};
        // 多表名
        //String[][] arrNames = {
        //        {"md_drainage_basin", "", "流域", "Integer"},
        //        {"md_lakes", null, "湖泊", "Integer"},
        //        {"md_reach", null, "河湖库", "Integer"},
        //        {"md_reservoir", null, "水库", "Integer"},
        //        {"md_river", null, "河流", "Integer"},
        //        {"md_water_system", null, "水系", "Integer"}
        //};
        genCode(arrNames,"ChenBin", "jdbc:mysql://localhost:3306/uip","root","root");
    }
     ...
     */
    public static void genCode(String[][] arrNames, String author, String jdbcUrl, String jdbcUser, String jdbcPwd) {
        ...
        for (int i = 0; i < arrNames.length; i++) {
            ...
            genCodeByCustomDomainName(tableName, domainName, description, pkDataType,author, jdbcUrl, jdbcUser, jdbcPwd);
        }
    }
    ...
    public static void genCodeByCustomDomainName(String tableName, String domainName, String description, String pkDataType,
                                                 String author, String jdbcUrl, String jdbcUser, String jdbcPwd) {
        genDomainAndMapper(tableName, domainName, jdbcUrl, jdbcUser, jdbcPwd);
        genService(tableName, domainName, description, pkDataType, author);
        genController(tableName, domainName, description, pkDataType, author);
        genDTO(tableName, domainName, description, pkDataType, author);
    }

    public static void genDomainAndMapper(String tableName, String domainName, String jdbcUrl, String jdbcUser, String jdbcPwd) {
    ...
    public static void genService(String tableName, String domainName, String description, String pkDataType, String author) {
        try {
    ...
    public static void genController(String tableName, String domainName, String description, String pkDataType, String author) {
        try {
            freemarker.template.Configuration cfg = getConfiguration();
    ...
    public static void genDTO(String tableName, String domainName, String description, String pkDataType, String author) {
        try {
            freemarker.template.Configuration cfg = getConfiguration();
